const H = globalThis, j = H.ShadowRoot && (H.ShadyCSS === void 0 || H.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, D = /* @__PURE__ */ Symbol(), Z = /* @__PURE__ */ new WeakMap();
let it = class {
  constructor(t, e, s) {
...
const ct = (r) => new it(typeof r == "string" ? r : r + "", void 0, D), ht = (r, ...t) => {
...
const { is: pt, defineProperty: ut, getOwnPropertyDescriptor: _t, getOwnPropertyNames: $t, getOwnPropertySymbols: ft, getPrototypeOf: mt } = Object, R = globalThis, K = R.trustedTypes, gt = K ? K.emptyScript : "", vt = R.reactiveElementPolyfillSupport, w = (r, t) => r, k = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? gt : null;
      break;
  ...
  return e;
} }, L = (r, t) => !pt(r, t), F = { attribute: !0, type: String, converter: k, reflect: !1, useDefault: !1, hasChanged: L };
...
b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[w("elementProperties")] = /* @__PURE__ */ new Map(), b[w("finalized")] = /* @__PURE__ */ new Map(), vt?.({ ReactiveElement: b }), (R.reactiveElementVersions ??= []).push("2.1.2");
const B = globalThis, G = (r) => r, M = B.trustedTypes, Q = M ? M.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, rt = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, nt = "?" + f, yt = `<${nt}>`, v = document, x = () => v.createComment(""), P = (r) => r === null || typeof r != "object" && typeof r != "function", V = Array.isArray, bt = (r) => V(r) || typeof r?.[Symbol.iterator] == "function", z = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, X = /-->/g, Y = />/g, m = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), tt = /'/g, et = /"/g, ot = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), u = At(1), A = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), st = /* @__PURE__ */ new WeakMap(), g = v.createTreeWalker(v, 129);
function at(r, t) {
...
const Ct = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const a = r[l];
    let h, p, c = -1, _ = 0;
    for (; _ < a.length && (o.lastIndex = _, p = o.exec(a), p !== null); ) _ = o.lastIndex, o === S ? p[1] === "!--" ? o = X : p[1] !== void 0 ? o = Y : p[2] !== void 0 ? (ot.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = m) : p[3] !== void 0 && (o = m) : o === m ? p[0] === ">" ? (o = i ?? S, c = -1) : p[1] === void 0 ? c = -2 : (c = o.lastIndex - p[2].length, h = p[1], o = p[3] === void 0 ? m : p[3] === '"' ? et : tt) : o === et || o === tt ? o = m : o === X || o === Y ? o = S : (o = m, i = void 0);
    const $ = o === m && r[l + 1].startsWith("/>") ? " " : "";
    n += o === S ? a + yt : c >= 0 ? (s.push(h), a.slice(0, c) + rt + a.slice(c) + f + $) : a + f + (c === -2 ? l : $);
  }
...
class U {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = U.createElement(h, s), g.currentNode = this.el.content, e === 2 || e === 3) {
    ...
    for (; (i = g.nextNode()) !== null && a.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const c of i.getAttributeNames()) if (c.endsWith(rt)) {
          const _ = p[o++], $ = i.getAttribute(c).split(f), N = /([.?@])?(.*)/.exec(_);
          a.push({ type: 1, index: n, name: N[2], strings: $, ctor: N[1] === "." ? wt : N[1] === "?" ? Et : N[1] === "@" ? xt : I }), i.removeAttribute(c);
        ...
        if (ot.test(i.tagName)) {
          ...
          if (_ > 0) {
            ...
            for (let $ = 0; $ < _; $++) i.append(c[$], x()), g.nextNode(), a.push({ type: 2, index: ++n });
            i.append(c[_], x());
          }
        }
...
class O {
  ...
  _$AI(t, e = this) {
    t = C(this, t, e), P(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== A && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : bt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class I {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = C(this, t, e, 0), o = !P(t) || t !== this._$AH && t !== A, o && (this._$AH = t);
    else {
      const l = t;
      let a, h;
      for (t = n[0], a = 0; a < n.length - 1; a++) h = C(this, l[s + a], e, a), h === A && (h = this._$AH[a]), o ||= !P(h) || h !== this._$AH[a], h === d ? t = d : t !== d && (t += (h ?? "") + n[a + 1]), this._$AH[a] = h;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
Ut?.(U, O), (B.litHtmlVersions ??= []).push("3.3.2");
const Ot = (r, t, e) => {
...
const Ht = { attribute: !0, type: String, converter: k, reflect: !1, hasChanged: L }, kt = (r = Ht, t, e) => {
...
var Mt = Object.defineProperty, Rt = Object.getOwnPropertyDescriptor, T = (r, t, e, s) => {
...
let y = class extends E {
  ...
  _updateStreams() {
    ...
    const r = this.shadowRoot?.getElementById("corte-audio");
    ...
    const t = this.shadowRoot?.getElementById("corte-video");
  ...
  get _cameraUrl() {
    return !this._config?.camera_entity || !this.hass || !this.hass.states[this._config.camera_entity] ? null : `/api/camera_proxy/${this._config.camera_entity}`;
  }
  _answerCall() {
  ...
  _renderActiveCall() {
    ...
    return setTimeout(() => this._updateStreams(), 0), u`
      <div class="active-call">
        ...
        ` : this._cameraUrl ? u`
          <img src="${this._cameraUrl}" class="camera-feed" />
        ` : u`<div class="call-icon active">📞</div>`}
        <audio 
          id="corte-audio"
          autoplay
        ></audio>
